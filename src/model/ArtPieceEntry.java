...
public class ArtPieceEntry extends ArtPiece {
    ...
    public ArtPieceEntry(int id, String name, String technique, ArtworkType type, int height, int width, int depth, int length, int year, boolean isSold, int buyerID, Image bitmap, String picturePath, String bitmapPath) {
